...
def print_sec_rule_out(rule_name_out,zone_names,local_nets,remote_nets):
    print(f'set rulebase security rules {rule_name_out} from VPN-S2S')
    print(f'set rulebase security rules {rule_name_out} to {zone_names}')
...
def print_sec_rule_in(rule_name_in,zone_names,remote_nets,local_nets):
    print(f'set rulebase security rules {rule_name_in} from {zone_names}')
    print(f'set rulebase security rules {rule_name_in} to VPN-S2S')
